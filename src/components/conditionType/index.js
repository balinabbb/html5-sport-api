...
export default class extends React.Component {
    ...
    fetchItems() {
        api.conditionType.all()(items => this.setState({ items }))
    }
    ...
    modalSaveClick() {
        ...
        api.conditionType.save(name, description)(() =>
        ...
        return (
            <div>
                <Button
                    ...
                    style={{ marginBottom: 20 }}>Új condition type</Button>
                <Table
